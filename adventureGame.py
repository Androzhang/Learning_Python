...
def start(devil, pack):
    ...
    if choice == "1":
        ...
        print_pause("You are about to knock when the door opens and out steps a " + devil + ".")
...
def house(devil, pack):   
    ...
    if res_house == "1":
        if pack == [] :
            ...
            weapon = pack[0]
            print_pause("As the " + devil + "moves to attack, you unsheath your new " + weapon + ".")
            print_pause("The " + weapon + "shines brightly in your hand as you brace yourself for the attack.")
            print_pause("But the " + devil + " takes one look at your shiny new toy and runs away!")
            print_pause("You have rid the town of the " + devil + ". You are victorious!") 
            replay(devil, pack)         
    elif res_house == "2":
...
def cave(devil, pack):
    if pack == [] :
        ...
        print_pause("You discard your silly old dagger and take the " + weapon + " with you.")
    else:
